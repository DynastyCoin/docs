...
The Dynasty Studio REST API for accessing the data and the services of the Dynasty network in a simple way. You can use this API to query and interact with the objects of the Dynasty network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Dynasty network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Dynasty\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Dynasty network |
...
| homeBridgeAddress | `String` | Bridge address on the Dynasty network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Dynasty network |
...
Community is a set of contracts and services. Members of the community are users of the Dynasty network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Dynasty network |
| homeTokenAddress | `String` | Address of the community token on the Dynasty network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Dynasty network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Dynasty network |
...
Entity is an account on the Dynasty network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Dynasty network |
