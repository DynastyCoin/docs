...
[Any entity that is holding the Dynasty token can run a node](broken-reference) that approves transaction in the network and in doing so receive rewards in the form of Dynasty token (DNY).
...
[You can delegate you Dynasty token to a validator](broken-reference) of your choosing. Not everybody that wants to earn rewards need to be a validator! Any token holder can delegate their Dynasty token to a validator to earn rewards through the validator.
