---
description: This tutorial will explain how to delegate/stake/unstake your DNY.
---

# Staking tutorial

Note: You can only stake DNY which is on Dynasty network. Please make sure you have changed into Dynasty network in Metamask while doing any transactions on staking UI. 

How to Stake Dynasty:

**Step 1:**

Navigate to staking.dynastycoin.io and login to your wallet through metamask. Make sure you are on Dynasty network. If you are not please follow the instructions [**here**](https://docs.dynastycoin.io/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of DNY you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
